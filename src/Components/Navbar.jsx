  ...
  return (
    ...
    <div className="nav-banner">
      ...
      <div className="jo-container">
        ...
        <div className="jo-card-content">
          ...
          <p className="jo-desc">Created both the class diagram and the "review controls" sequence diagram. Lastly, I contributed to the report and a small portion of the presentation</p>
        </div>
      </div>
      ...
      <div className="jack-container">
        <div className="jack-card-content">
          ...
          <p className="jack-desc">Worked on Use Case diagram as well as documented and explained UI prototype given by the MIS team putting new ideas where possible</p>
        </div>
      ...
      <div className="ben-container">
        ...
        <div className="jo-card-content">
          ...
          <p className="jo-desc">Designed and developed the group webpage. Created the Order Controls sequence diagram to show the system interactions and workflow for this feature</p>
        </div>
      </div>
    <div className="koy-container">
        <div className="jack-card-content">
          ...
          <p className="jack-desc">Helped in the design of UML diagrams, specifically the QC builder sequence diagram. As well as assisted with the UML section of the report and presentation</p>
        </div>
        <div className="jack-picture-card">
          <motion.img whileHover={{
            scale: 1.2,
      ...
      <div className="upcoming-tasks">
        <motion.div whileHover={{
          ...
          whileTap={{ scale: 1 }} className="task-box"><div className="checkbox"><img src={check} className="check" /></div><div className="task">Complete Stage 2</div></motion.div>
        <motion.div whileHover={{
            scale: 1.05,
            transition: { duration: 0.2  },
          }}
          whileTap={{ scale: 1 }} className="task-box"><div className="checkbox"></div><div className="task">Meet with Huy</div></motion.div>
        <motion.div whileHover={{
            scale: 1.05,
            transition: { duration: 0.2  },
          }}
          whileTap={{ scale: 1 }} className="task-box"><div className="checkbox"></div><div className="task">Start Frontend and database</div></motion.div>
        <motion.div whileHover={{
            scale: 1.05,
            transition: { duration: 0.2  },
          }}
          whileTap={{ scale: 1 }} className="task-box"><div className="checkbox"></div><div className="task">Work on backend / debugging</div></motion.div>
        <motion.div whileHover={{
            scale: 1.05,
            transition: { duration: 0.2  },
          }}
